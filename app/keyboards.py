...
async def accept(order_id, message_id):
    keyboard = InlineKeyboardBuilder()
    keyboard.add(InlineKeyboardButton(text='Принять заказ', callback_data=f'accept_{order_id}_{message_id}'))
    return keyboard.adjust().as_markup()
...
async def time_wait(order_id, message_id):
    keyboard = InlineKeyboardBuilder()
    keyboard.add(InlineKeyboardButton(text='2-3 мин.', callback_data=f'timewait_{order_id}_3_{message_id}'))
    keyboard.add(InlineKeyboardButton(text='5 мин.', callback_data=f'timewait_{order_id}_5_{message_id}'))
    keyboard.add(InlineKeyboardButton(text='8 мин.', callback_data=f'timewait_{order_id}_8_{message_id}'))
